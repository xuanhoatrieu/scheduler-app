                  ...
                  <View style={styles.tuitionSummaryCard}>
                    ...
                    <View style={styles.tuitionRow}>
                      <Text style={styles.tuitionLblBold}>
                        {financeData.overallSurplus > 0 ? 'Đang nộp thừa:' : (financeData.overallDebt > 0 ? 'Còn nợ học phí:' : 'Nghĩa vụ học phí:')}
                      </Text>
                      <Text style={[styles.tuitionValBold, { color: financeData.overallDebt > 0 ? '#ef4444' : '#2e7d32' }]}>
                        {financeData.overallSurplus > 0 ? `+${financeData.overallSurplus.toLocaleString()}đ` : (financeData.overallDebt > 0 ? `-${financeData.overallDebt.toLocaleString()}đ` : '✓ Đã nộp đủ (0đ)')}
                      </Text>
                    </View>
                  </View>
